    ...
    <div className="bg-white rounded-xl shadow-lg p-6 mt-6 animate-on-load fade-up duration-slow">
      ...
      <div className="bg-gray-50 rounded-lg p-4 border border-gray-200 animate-on-load zoom-in duration-normal">
        ...
        <ul className="text-sm text-gray-600 space-y-1 list-disc list-inside">
          <li><code className="bg-gray-200 px-1 rounded">STRIPE_SECRET_KEY</code> - Server-side API key</li>
          <li><code className="bg-gray-200 px-1 rounded">STRIPE_PUBLISHABLE_KEY</code> - Client-side key</li>
          <li><code className="bg-gray-200 px-1 rounded">STRIPE_WEBHOOK_SECRET</code> - Webhook verification</li>
        </ul>
