  ...
  if (loading && !partners.length) {
    return (
      <div className="text-center py-12 animate-on-load fade-up duration-normal">
        ...
        <p className="text-gray-600 animate-on-load fade-down duration-light-slow">Loading partners...</p>
      </div>
    );
  }
      ...
      <table className="w-full">
        ...
        <tbody>
          {partners.map((partner) => (
            <tr key={partner.id} className="border-b border-gray-100 hover:bg-gray-50 animate-on-load fade-left duration-slow">
