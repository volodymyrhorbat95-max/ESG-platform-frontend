  ...
  const getMessage = () => {
    switch (caseType) {
      ...
      case 'B':
        ...
        if (isAboveThreshold) {
          return {
            title: 'Certified Asset Created',
            message: `${displayName} has purchased real assets for the removal of ${impactKg.toFixed(2)}kg of plastic for you. You now have a certified and auditable title.`,
          };
        }
        return {
          title: 'Accumulation Started',
          message: `${displayName} has funded your accrual for the removal of ${impactGrams}g of plastic. Upon reaching €10, your credits will become a certified asset in your name.`,
        };
      ...
      case 'C':
        ...
        if (isAboveThreshold) {
          return {
            ...
            message: `Great choice. With your contribution of €${amount.toFixed(2)}, you have purchased real environmental assets for the removal of ${impactKg.toFixed(2)}kg of plastic. Your title is now auditable and guaranteed by the CPRS protocol.`,
            note: 'Your Amplivo Corsair Connect account will be automatically activated.',
          };
        }
        return {
          title: 'Accumulation Path Started',
          message: `Great choice. With your contribution of €${amount.toFixed(2)}, you have started your accrual path for the removal of ${impactGrams}g of plastic. Upon reaching the €10 threshold, you will redeem your first certified environmental assets.`,
        };
