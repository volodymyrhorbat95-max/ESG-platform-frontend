  ...
  return (
    <footer className="mt-12 border-t border-gray-200 pt-8 animate-on-load fade-up duration-slow">
      ...
      <div className="flex flex-wrap items-center justify-center gap-6 mb-6">
        <div className="flex items-center gap-2 bg-gray-100 px-4 py-2 rounded-lg animate-on-load zoom-in duration-fast">
        ...
        <div className="flex items-center gap-2 bg-gray-100 px-4 py-2 rounded-lg animate-on-load zoom-in duration-light-slow">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-6 max-w-4xl mx-auto animate-on-load fade-up duration-light-slow">
      ...
      {/* Copyright */}
      <div className="text-center text-xs text-gray-400 mt-6 animate-on-load fade-up duration-very-slow">
