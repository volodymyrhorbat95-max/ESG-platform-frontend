...
export default function Tooltip({ children, content, className = '' }: TooltipProps) {
  ...
  return (
    <span className="relative inline-block">
      ...
      {isVisible && (
        <span className="absolute z-[9999] bottom-full left-1/2 -translate-x-1/2 mb-2 pointer-events-none" style={{ width: '320px', maxWidth: '90vw' }}>
          <span className="bg-slate-700 text-white text-sm rounded-lg p-4 shadow-xl border border-slate-600 block relative">
            {/* Arrow pointing down */}
