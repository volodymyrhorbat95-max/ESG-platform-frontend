export default function PaymentProcessing() {
  return (
    <section>
      <h2 className="text-xl font-semibold text-gray-800 mt-6 mb-3 animate-on-load fade-down duration-fast">6. Payment Processing</h2>
      <p className="animate-on-load zoom-in duration-normal">
