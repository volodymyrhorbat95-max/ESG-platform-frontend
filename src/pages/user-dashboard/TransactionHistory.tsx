...
// Certificate download available for ALL completed transactions (not just ≥€10)
      ...
      <table className="w-full">
        <thead>
          <tr className="border-b border-gray-200">
            ...
            <th className="text-left py-3 px-4 text-sm font-semibold text-gray-700 animate-on-load fade-down duration-fast">SKU</th>
        ...
        <tbody>
          {transactions.map((transaction: any) => (
            <tr key={transaction.id} className="border-b border-gray-100 hover:bg-gray-50 animate-on-load fade-up duration-normal">
              ...
              <td className="py-3 px-4 text-sm text-gray-800 font-medium animate-on-load zoom-in duration-normal">
