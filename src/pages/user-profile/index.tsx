    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center animate-on-load fade-down duration-normal">
          ...
          <button
            onClick={() => navigate('/')}
            className="mt-4 bg-primary text-white px-6 py-2 rounded-lg hover:bg-green-600 animate-on-load fade-up duration-slow"
          >
            Go Home
          </button>
        </div>
      ...
      <div className="bg-white border-b border-gray-200 shadow-sm animate-on-load fade-down duration-fast">
        <div className="max-w-4xl mx-auto px-4">
          <div className="flex items-center justify-between h-12">
            <span className="text-sm font-medium text-gray-600 animate-on-load fade-right duration-normal">User Profile</span>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 mb-6 animate-on-load fade-up duration-normal">
            <div className="flex justify-between items-center">
              <div>
                <h1 className="text-3xl font-bold text-gray-800 mb-2 animate-on-load fade-right duration-fast">User Profile</h1>
                <p className="text-gray-600 animate-on-load fade-left duration-light-slow">Manage your account information</p>
              </div>
              <button
